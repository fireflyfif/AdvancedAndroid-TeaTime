...
public class OrderSummaryActivityTest {
    ...
    private static final String emailMessage = "Test message here.";


    // COMPLETED (2) Add the rule that indicates we want to use Espresso-Intents APIs in functional UI tests
    @Rule
    public IntentsTestRule<OrderSummaryActivity> mOrderActivity =
    ...
    public void stubAllExternalIntents() {
        ...
        // Use Stub Intent to stub all external intents
